...
task_config = {'camera_names': ["left", "right"]}
...
def inference_process(args, config, ros_operator, policy, stats, t, pre_action):
    ...
    while True and not rospy.is_shutdown():
        ...
        image_dict[config['camera_names'][0]] = img_left
        ...
        if args.use_depth_image:
            ...
            image_depth_dict[config['camera_names'][0]] = img_left_depth
            image_depth_dict[config['camera_names'][1]] = img_right_depth
...
def model_inference(args, config, ros_operator, save_episode=True):
    ...
    print("publish to /master/left & /master/right")
    ...
    def puppet_arm_publish_continuous(self, left, right):
        ...
        while True and not rospy.is_shutdown():
            ...
            if left_arm is None or right_arm is None:
                ...
                break
        print(f"after {left_arm} {right_arm}")
